...
(function testHTMLHeadlineAsString(){
  ...
  assert.isTrue(storyListView.headlineToHTML() === "<div class='story'>image<a id=0 href='#story/0'>hey</a><br><a href='www.test.com'>Read the Full Story</a></div><div id='summary'>test news summary</div>")
  console.log('.')
})();
...
(function testMutipleStoriesHTMLHeadlineToString(){
  ...
  var storyListView = new StoryListView(storyList)
  assert.isTrue(storyListView.headlineToHTML() === "<div class='story'>image<a id=0 href='#story/0'>hey</a><br><a href='www.test.com'>Read the Full Story</a></div><div id='summary'>summary1</div><br><br><div class='story'>image2<a id=1 href='#story/1'>howdy</a><br><a href='www.test2.com'>Read the Full Story</a></div><div id='summary'>summary2</div>")
  console.log('.')
})();